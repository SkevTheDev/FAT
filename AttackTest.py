...
sys.path.insert(1, 'd:/deeplearning/adversarial/FAT/FAT/models')  # python only searches for files in local folder
from Models import *  #folder name is case sensitive
import AttackGenerator as attack
from Resnet import *
...
parser.add_argument('--model_path', default='./FAT_results/checkpoint_Resnet18_120Epochs.pth.tar', help='model for white-box attack evaluation')
...
if args.dataset == "cifar10":
    ...
    test_loader = torch.utils.data.DataLoader(testset, batch_size=128, shuffle=False, num_workers=0) # was 2 - 2 does not work under pytorch for win 10, will give broken pipe error, or freeze_support error
